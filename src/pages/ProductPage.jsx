  ...
  return (
    <motion.div
      ...
      style={{
        ...
        zIndex: 200,
        overflow: "hidden",
        background: `radial-gradient(ellipse at 100% 100%, ${product.hex}ff 0%, ${product.hex}cc 45%, ${product.hex}88 70%, #0a0a0b 100%)`,
      }}
    >
      {/* ── HIGH-CONTRAST VISIBLE GRAIN OVERLAY ── */}
      {/* ── HIGH-CONTRAST VISIBLE GRAIN OVERLAY ── */}
<div
  style={{
    position: "absolute",
    ...
    height: "100%",
    pointerEvents: "none",
    zIndex: 99, /* Brings it right to the top of the local page content */
    opacity: 0.4, /* Raised opacity so it is clearly visible over the dark gradient */
    mixBlendMode: "overlay",
    backgroundImage: `url("data:image/png;base64,")`,
